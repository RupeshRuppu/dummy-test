...
const UserRegistrationVerfication = lazy(() =>
	import("./pages/auth/register/userRegistrationVerification.js")
);
const RegistrationSuccess = lazy(() =>
	import("./pages/auth/register/registrationSuccessfull.js")
);
...
const ForgotPasswordEmailVerfication = lazy(() =>
	import("./pages/auth/forgotpassword/forgotPasswordEmailVerification.js")
);
			...
			<ThemeContext.Provider value={{ isDarkMode, toggleTheme }}>
				<RoutesWrapper isDarkMode={isDarkMode}>
					<Routes>
						<Route
							element={
								<ProtectedRoute isAllowed={!AuthService.getCurrentUser()} />
							}
						>
							<Route
